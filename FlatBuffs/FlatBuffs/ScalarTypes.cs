...
public struct ScalarTypes : IFlatbufferObject
{
  ...
  public static Offset<FlatBuffs.ScalarTypes> CreateScalarTypes(FlatBufferBuilder builder,
      sbyte byteType = 0,
      byte ubyteType = 0,
      bool boolType = false,
      short shortType = 0,
  ...
  public static Offset<FlatBuffs.ScalarTypes> EndScalarTypes(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<FlatBuffs.ScalarTypes>(o);
  }
};
